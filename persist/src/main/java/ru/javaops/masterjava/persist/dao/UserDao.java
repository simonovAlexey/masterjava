...
public abstract class UserDao implements AbstractDao {
    ...
    @SqlUpdate("INSERT INTO users (full_name, email,city, flag) VALUES (:fullName, :email,:city, CAST(:flag AS USER_FLAG)) ")
    @GetGeneratedKeys
    abstract int insertGeneratedId(@BindBean User user);

    @SqlUpdate("INSERT INTO users (id, full_name, email,city, flag) VALUES (:id, :fullName, :email,:city, CAST(:flag AS USER_FLAG)) ")
    ...
    @SqlBatch("INSERT INTO users (id, full_name, email,city, flag) VALUES (:id, :fullName, :email,:city, CAST(:flag AS USER_FLAG))" +
